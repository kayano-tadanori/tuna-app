...
def tape(oy, frac, cap, label, w=480, x0=20):
    mx = x0 + w * frac
    out = [rect(x0, oy, w, 30, LINE, 2),
           ln(mx, oy - 6, mx, oy + 36, HI, 1.8),
           t(mx, oy + 50, cap, HI, 12),
           t(x0 - 10, oy + 20, label, TX, 13, "end")]
    out += dim(x0, oy + 44, x0 + w, oy + 44, "60", 20, side=1)
    return out


_a = []
_a += tape(20, 2 / 3.0, "40分(2/3時間)", "①")
_a += tape(140, 1 / 4.0, "15秒(1/4分)", "②")
_a += tape(260, 5 / 6.0, "50秒(5/6分)", "③")
