...
_b46 += [poly(_uverts, LINE, 1.8),
          ...
          t(195, 130, "②", GRAY, 12)]
EX46, EY46, EW46, EH46 = 280, 20, 110, 100
ARM46, SPINE46 = 22, 22
GAP46 = (EH46 - 3 * ARM46) / 2
_zverts = [
    (EX46 + EW46, EY46), (EX46, EY46), (EX46, EY46 + ARM46),
    (EX46 + EW46 - SPINE46, EY46 + ARM46), (EX46 + EW46 - SPINE46, EY46 + ARM46 + GAP46),
    (EX46, EY46 + ARM46 + GAP46), (EX46, EY46 + ARM46 + GAP46 + ARM46),
    (EX46 + EW46 - SPINE46, EY46 + ARM46 + GAP46 + ARM46), (EX46 + EW46 - SPINE46, EY46 + EH46 - ARM46),
    (EX46, EY46 + EH46 - ARM46), (EX46, EY46 + EH46), (EX46 + EW46, EY46 + EH46),
]
_b46 += [poly(_zverts, LINE, 1.8)]  # 背骨が右側の「逆E（Ǝ）」＝一枚板（本人指摘で修正）
_b46 += [t(EX46 + 14, EY46 + ARM46 / 2 + 4, "A", TX, 12),
          t(EX46 + EW46 - 16, EY46 + ARM46 / 2 + 4, "B", TX, 12),
          t(EX46 + 14, EY46 + ARM46 + GAP46 + ARM46 / 2 + 4, "C", TX, 12),
          t(EX46 + 14, EY46 + EH46 - ARM46 / 2 + 4, "×", HI, 13),
          t(EX46 + EW46 / 2, EY46 + EH46 + 20, "③", GRAY, 12)]
