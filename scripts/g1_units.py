...
COUNT = [u"人目", u"番目", u"個目", u"回目", u"人", u"個", u"本", u"枚", u"冊", u"台",
         ...
         u"班",
         # ★旗を立てる「9か所」（2026-09-19・演習教材 第1分冊 No.9 B11・C6）
         u"か所"]
...
NOT_UNIT_WORDS = [u"あまり", u"余り",
                  ...
                  u"に最も近い",
                  # ★数の組「12と132, 60と84」の「と」（2026-09-19・演習教材 第1分冊 No.10 B9・B10）。
                  #   帯分数「1と2/3」は分数として先に読まれるので、ここには来ない（回帰で確認）
                  u"と"]
...
TESTS = [
    ...
    (u"9か所", {u"か所": u"9"}, {}),                                     # 2026-09-19：場所の数
    (u"12と132, 60と84", {}, {}),                                        # 2026-09-19：数の組（単位なし）
