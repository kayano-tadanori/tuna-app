...
P7 = {"A": (60, 40), "B": (230, 30), "C": (60, 130), "D": (170, 130),
      "F": (40, 240), "G": (230, 230), "E": (100, 230)}
_b07 = [rect(20, 15, 290, 260, LINE, 1.4)]
_b07 += battery((P7["A"][0] + P7["B"][0]) / 2, (P7["A"][1] + P7["B"][1]) / 2, 30, 16)
_b07 += [ln(P7["A"][0] + 15, P7["A"][1], P7["A"][0] + 25, P7["A"][1], LINE, 1.8),
         ln(P7["B"][0] - 25, P7["B"][1], P7["B"][0] - 15, P7["B"][1], LINE, 1.8)]
_b07 += battery((P7["C"][0] + P7["D"][0]) / 2, (P7["C"][1] + P7["D"][1]) / 2, 30, 16)
_b07 += [ln(P7["C"][0] + 15, P7["C"][1], P7["C"][0] + 25, P7["C"][1], LINE, 1.8),
         ln(P7["D"][0] - 25, P7["D"][1], P7["D"][0] - 15, P7["D"][1], LINE, 1.8)]
_b07 += battery((P7["C"][0] + P7["E"][0]) / 2, (P7["C"][1] + P7["E"][1]) / 2, 16, 30, vertical=True)
_b07 += [ln(P7["C"][0], P7["C"][1] + 15, P7["C"][0], P7["C"][1] + 25, LINE, 1.8),
         ln(P7["E"][0], P7["E"][1] - 25, P7["E"][0], P7["E"][1] - 15, LINE, 1.8)]
_b07 += battery((P7["F"][0] + P7["G"][0]) / 2, (P7["F"][1] + P7["G"][1]) / 2, 30, 16)
_b07 += [ln(P7["F"][0] + 15, P7["F"][1], P7["F"][0] + 25, P7["F"][1], LINE, 1.8),
         ln(P7["G"][0] - 25, P7["G"][1], P7["G"][0] - 15, P7["G"][1], LINE, 1.8)]
_b07 += [ln(P7["B"][0], P7["B"][1], P7["B"][0], P7["G"][1], GRAY, 1.8), ln(P7["B"][0], P7["G"][1], P7["G"][0], P7["G"][1], GRAY, 1.8)]
for k, (x, y) in P7.items():
    fill = "#111827" if k in ("B", "G") else TX
...
_b10 += [poly(_uverts, LINE, 1.8),
         ...
         t(195, 130, "②", GRAY, 12)]
_everts = [(280, 20), (380, 20), (380, 45), (310, 45), (310, 60), (380, 60), (380, 85), (310, 85), (310, 110), (380, 110)]
_b10 += [pline(_everts, LINE, 1.8),
         t(384, 24, "C", TX, 12, "start"), t(320, 78, "B", TX, 12, "start"),
         t(288, 116, "A", TX, 12), t(384, 114, "×", HI, 13, "start"), t(330, 130, "③", GRAY, 12)]
