# -*- coding: utf-8 -*-
u"""No.15 の図を iPhone はば(414px)で 実際に描いて PNG にする（目視確認用）"""
import os, sys, io
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from playwright.sync_api import sync_playwright
import gen_s3sairei_no15 as g

BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT = os.path.join(BASE, "scripts", "_no15_shots")
os.makedirs(OUT, exist_ok=True)

NAMES = ["fig_1_1", "fig_1_2", "fig_2_1", "fig_2_2", "fig_3_1", "fig_3_2", "fig_4_1",
         "fig_4_2", "fig_5", "fig_6_1", "fig_6_2", "fig_6_3", "fig_7_1", "fig_7_2"]
