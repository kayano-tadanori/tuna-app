...
OUT = os.path.join(BASE, "scripts", "_nadago_2408_shots")
PORT = 8771
# (学年, 回, id, ピッカーで探す語, 小問の答え)
WANT = [(4, 11, "hd4n_11_12", "ふたのない容器", ["250","10","5","3","150","1500","500","2000"]),

        (5, 6, "hd5n_06_9", "ふたのない容器", ["250","10","5","3","150","1500","500","2000"])]
