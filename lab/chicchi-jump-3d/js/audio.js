  ...
  play(name, arg) {
    ...
    switch (name) {
      ...
      case 'unit':
        ...
        break;
      // 📻 公園のベンチのラジオ。ザーッというノイズと、遠い電波のビープ。
      //   ★きれいな音にしない。「遠くから、やっと届いた声」に聞こえることが大事。
      case 'radio':
        for (let i = 0; i < 5; i++) {
          this.noise(0.55, { freq: 1500, to: 700, q: 0.7, gain: 0.055, delay: i * 0.42 });
        }
        this.tone(1180, 0.10, { type: 'square', gain: 0.035, delay: 0.30 });
        this.tone(880,  0.10, { type: 'square', gain: 0.030, delay: 0.46 });
        this.tone(1180, 0.08, { type: 'square', gain: 0.028, delay: 1.90 });
        break;
      // 🚀 ズギューン。バネがのびる音＋低いところから駆け上がる音。
      case 'zugyun':
        this.tone(150, 0.60, { type: 'sawtooth', gain: 0.10, to: 1500 });
        this.tone(300, 0.45, { type: 'square',   gain: 0.05, to: 2200, delay: 0.03 });
        this.noise(0.35, { freq: 400, to: 3000, q: 0.8, gain: 0.16 });
        break;
      case 'voyLine':
        // セリフの合いの手。うるさくしない。
      ...
      case 'wing':
        ...
        break;
      case 'jumbo':
        // ✈️ ジャンボがかすめる音。低いうなりが近づいて、通りすぎて遠のく。
        //   ★1つの音を長く鳴らす。短い音を並べると「機械音」になる。
        this.tone(58,  4.4, { type: 'sawtooth', gain: 0.05, to: 44 });
        this.tone(112, 4.4, { type: 'triangle', gain: 0.035, to: 82, delay: 0.05 });
        this.tone(176, 3.4, { type: 'sine',     gain: 0.022, to: 130, delay: 0.6 });
        break;
      case 'milestone':
        [0, 4, 7].forEach((s, i) =>
